...
$loginResp = Invoke-WebRequest -Uri "$Domain/api/login" -Method POST -ContentType "application/json" -Body (ConvertTo-Json @{username="vhr"; password="VHR@Render#2025!SecureAdmin789"}) -UseBasicParsing
